/* Fairline — local dashboard server (Livebot server.js pattern). Bound to
 * 127.0.0.1 ONLY, Host-header allowlist as DNS-rebinding hygiene. Static
 * page + JSON state endpoint; POST /api/panic closes everything and halts. */
'use strict';
