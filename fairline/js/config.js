...
const CONFIG = {
  ...
  STRATEGY: {
    ...
    minSigmaHourPct: 0,            // volatility gate: skip entries when realized vol is
                                   // below this (%/√hour); 0 disables. Dead markets pin
                                   // spot near the window open and make confidence noise.
  },
